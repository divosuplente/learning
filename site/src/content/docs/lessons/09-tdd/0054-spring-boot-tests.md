...
The key insight: **narrower slices run faster and fail closer to the bug.** A `@WebMvcTest` runs in ~2 seconds. A `@SpringBootTest` often takes 10–30 seconds. Reach for the narrowest slice that proves what you need.
